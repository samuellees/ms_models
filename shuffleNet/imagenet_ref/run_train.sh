...
PATH_MODEL="/userhome/ms_models/shuffleNet/imagenet_ref"
...
$PYTHON_EXE train.py --train-dir=$PATH_DATA"train" --val-dir=$PATH_DATA"val"
# $PYTHON_EXE train.py --train-dir=$PATH_DATA"train" --val-dir=$PATH_DATA"val" > log.txt 2>&1 
cd ..
