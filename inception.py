...
class Inception_v3(nn.Cell):
    """
    Inception v3
    """

    def __init__(self, num_classes=1000, create_aux_logits=True):
        ...
        self.AvgPool_last = nn.AvgPool2d(kernel_size=8, pad_mode="valid")
...
class InceptionBlockA(nn.Cell):
    ...
    def __init__(self, in_channels, var_channels):
        ...
        self.branch_2 = nn.SequentialCell([
                            ...
                            Conv2dBlock(in_channels=48, out_channels=64, kernel_size=5, padding=2)])
        self.branch_3 = nn.SequentialCell([
                            Conv2dBlock(in_channels, out_channels=64, kernel_size=1),
                            Conv2dBlock(in_channels=64, out_channels=96, kernel_size=3, padding=1),
                            Conv2dBlock(in_channels=96, out_channels=96, kernel_size=3, padding=1)])
...
class InceptionBlockC_2(nn.Cell):
    ...
    def __init__(self, in_channels):
        ...
        self.branch_3_a = nn.SequentialCell([
                            ...
                            Conv2dBlock(in_channels=448, out_channels=384, kernel_size=3, padding=1)])
...
class InceptionBlockAux(nn.Cell):
    ...
    def __init__(self, in_channels, num_classes):
        ...
        self.conv_2 = Conv2dBlock(in_channels=128, out_channels=768, kernel_size=5, pad_mode="valid", weight_init=TruncatedNormal(0.01))
...
class Conv2dBlock(nn.Cell):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=1, stride=1, pad_mode="same", padding=0, 
                 weight_init=XavierUniform(), activations=nn.ReLU()):
        super(Conv2dBlock, self).__init__()
        self.conv = nn.Conv2d(in_channels, out_channels, kernel_size, stride, pad_mode, padding, weight_init)
