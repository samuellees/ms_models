...
rm -rf ./test_train_perf
mkdir ./test_train_perf
mkdir ./test_train_perf/ckpt_0
cp ../*.py ./test_train_perf
cp *.sh ./test_train_perf
cp -r ../src ./test_train_perf
cd ./test_train_perf || exit
