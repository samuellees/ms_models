...
cp ../*.py ./train_half_o2
cp *.sh ./train_half_o2
cp -r ../src ./train_half_o2
cd ./train_half_o2 || exit
echo "start training for device $DEVICE_ID"
env > env.log
$PYTHON_EXE train_half_o2.py --data_url=$PATH1 --seg_url=$PATH2 > train.log 2>&1
# $PYTHON_EXE train_half_o2.py --data_url=$PATH1 --seg_url=$PATH2
cd ..
